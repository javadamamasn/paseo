...
const ThemedKeyboardIcon = withUnistyles(KeyboardIcon);
const ThemedKeyboardOffIcon = withUnistyles(KeyboardOffIcon);
const ThemedLoadingSpinner = withUnistyles(LoadingSpinner);
const ThemedTerminalEmulator = withUnistyles(TerminalEmulator, (theme: Theme) => ({
...
function KeyboardToggleButton({ isKeyboardVisible, onToggle }: KeyboardToggleButtonProps) {
  ...
  return (
    ...
    >
      <Icon size={ICON_SIZE.md} uniProps={foregroundMutedColorMapping} />
    </Pressable>
  );
}
